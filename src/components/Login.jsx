    ...
    <div className="login-container">
      <div className="login-box">
        ...
        <div className="club-registros">
          ...
          <span>FEMETI: YUC 05/2020</span>
          <span>SEMARNAT: CIN-005-YUC-05</span>
        </div>
        ...
        <div className="social-links">
          ...
          <a href="https://maps.app.goo.gl/xUfQggW8jAG7gtC19" target="_blank" rel="noopener noreferrer" title="Ubicación">
          ...
          <div className="requisitos-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="requisitos-content">
              ...
              <div className="whatsapp-contact">
                <p>Para mayor información, contáctanos por teléfono o WhatsApp:</p>
                <a href="https://wa.me/5215665824667" target="_blank" rel="noopener noreferrer" className="whatsapp-btn">
