/**
 * SharedFooter - Footer compartido para toda la aplicación
 * Mismo diseño que LandingPage
 */
  ...
  return (
    <footer className="shared-footer">
      <div className="shared-footer-content">
        <div className="shared-footer-info">
          <h4>📍 Ubicación</h4>
        ...
        <div className="shared-footer-info">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="shared-whatsapp-link"
          >
            <svg className="shared-whatsapp-icon" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="mailto:tiropracticoyucatan@gmail.com" className="shared-email-link">tiropracticoyucatan@gmail.com</a>
        </div>
        <div className="shared-footer-info">
