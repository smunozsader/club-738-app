  ...
  if (role === 'administrator') {
    return (
      <div className="app-container admin-mode">
        ...
        {/* Footer Admin - Same as Landing Page */}
        <footer className="landing-footer admin-footer-full">
          ...
          <div className="footer-bottom">
            <p>© 2026 Club de Caza, Tiro y Pesca de Yucatán, A.C. Todos los derechos reservados. | Panel Administrativo</p>
          </div>
        </footer>
      </div>
    );
