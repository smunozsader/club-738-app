...
for arma_doc in armas:
    ...
    if tiene_pdf:
        ...
        print(f"✅ {clase:25} {marca:20} {modelo:15} MAT: {matricula:20} - PDF RFA: SÍ")
    else:
        sin_pdf.append(matricula)
        print(f"❌ {clase:25} {marca:20} {modelo:15} MAT: {matricula:20} - PDF RFA: NO")
